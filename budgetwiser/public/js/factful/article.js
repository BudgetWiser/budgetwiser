...
Factful.Info.prototype.generateView = function(infoView){
    ...
    $(_foldBtn).bind('click', {_info: this}, Factful.e.foldInfo);
};
...
Factful.Services.prototype.generateView = function(rightSide){
    ...
    this.list.map(function(item){
        ...
        _moneyView.innerHTML = '2014년 금액 : ' + Factful.moneyToStr(parseInt(item.money));
        ...
        _sibalView.innerHTML = '사업 예산 총액 : ' + Factful.moneyToStr(parseInt(item.sibal));
